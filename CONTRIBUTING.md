...
Gràcies per considerar contribuir a aquest projecte! Valorem molt la vostra ajuda per millorar l'aplicació.

## Com col·laborar

### Reportar Errors (Issues)
Si trobeu un error o teniu una idea per a una nova funcionalitat:
1. Reviseu si l'[Issue](https://github.com//Ponyoo7/projecte_despliegue/issues) ja existeix.
